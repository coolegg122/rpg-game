...
async function run() {
  ...
  if (!repoUrl || !username || !token) {
    console.log("Usage: node push_to_github.js <repoUrl> <username> <token>");
    console.log("\nExample:");
    console.log("  node push_to_github.js https://github.com/myuser/myrepo.git myuser ghp_myToken12345");
    process.exit(1);
  }
